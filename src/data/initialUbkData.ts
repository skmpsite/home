...
export const initialUbkRph: UbkRphItem[] = [
  {
    id: 'rph-gpk1-minggu-25',
    week: 25,
    date: '2026-09-12',
    time: '08:30 PG - 09:30 PG',
    sessionType: 'Pengajaran & Pembelajaran (PdP)',
    focus: 'Pengurusan Kurikulum & PdP Berkesan',
    title: 'PdP Bahasa Melayu Tahun 6: Tatabahasa & Penulisan Karangan Respons Kritis',
    target: 'Murid Tahun 6 Ibnu Khaldun (34 Murid)',
    venue: 'Bilik Darjah 6 Ibnu Khaldun',
    objective: 'Pada akhir sesi PdP, murid dapat: 1. Membina perenggan isi menggunakan formula I-MA-CA-P secara gramatis. 2. Menyunting sekurang-kurangnya 3 kesalahan ejaan dan kosa kata dalam petikan.',
    steps: [
      'Langkah 1: Set Induksi - Tayangan keratan artikel berita isu pemeliharaan alam sekitar (10 minit).',
      'Langkah 2: Pembelajaran Koperatif - Analisis isi tersurat dan tersirat dalam kumpulan (20 minit).',
      'Langkah 3: Aktiviti Penulisan Individu & Sesi Soal Jawab Berfokus KBAT (20 minit).',
      'Langkah 4: Penutup - Pembentangan rawak kumpulan dan rumusan refleksi guru (10 minit).'
    ],
    teachingAids: 'Buku Teks BM Thn 6, Lembaran Grafik I-Think, Papan Putih Mini, Projektor LCD',
    reflection: '31 daripada 34 murid berjaya mencapai objektif pembelajaran dengan cemerlang. 3 murid diberikan bimbingan susulan pada sesi tutorial petang.',
  ...
  {
    id: 'rph-gpkhem-minggu-25',
    week: 25,
    date: '2026-09-12',
    time: '10:30 PG - 11:30 PG',
    sessionType: 'Pengurusan Hal Ehwal Murid',
    focus: 'Peningkatan Disiplin & Amalan Guru Penyayang',
    title: 'Bimbingan Sahsiah Terpuji & Pengurusan Kehadiran Sifar Ponteng',
    target: 'Pemimpin Murid & Pengawas Sekolah (38 Murid)',
    venue: 'Dewan Terbuka SK Merbau Pulas',
    objective: 'Membimbing barisan pemimpin murid dalam pengurusan kawalan disiplin waktu rehat dan pembudayaan salam hormat sesama warga sekolah.',
    steps: [
      'Langkah 1: Taklimat prosedur pemantauan pagar sekolah dan kantin waktu pagi/rehat.',
      'Langkah 2: Simulasi pengurusan aduan murid dan pelaporan kes buli/disiplin ringkas.',
      'Langkah 3: Penyerahan lencana pemantau bertugas dan penetapan jadual giliran mingguan.'
    ],
    teachingAids: 'Buku Log Pengawas, Modul Disiplin Positif KPM, Sistem SSDM',
    reflection: 'Pengawas menunjukkan komitmen tinggi dan bersedia melaksanakan tugas pemantauan dengan penuh integriti.',
    counselorName: 'Penolong Kanan Hal Ehwal Murid (PK HEM)',
    authorRole: 'pk_hem',
    status: 'menunggu',
    submittedAt: '2026-09-12T08:00:00.000Z'
  },
  {
    id: 'rph-gpkko-minggu-25',
    week: 25,
    date: '2026-09-12',
    time: '02:00 PTG - 03:30 PTG',
    sessionType: 'Pengurusan Kokurikulum',
    focus: 'Kecemerlangan Badan Beruniform & Sukan Sekolah',
    title: 'Perjumpaan Mingguan Unit Beruniform: Kemahiran Ikatan, Simpulan & Kawad Kaki Asas',
    target: 'Semua Murid Tahap 2 (Tahun 4, 5 dan 6)',
    venue: 'Padang Sekolah & Foyer Utama SKMP',
    objective: 'Murid dapat mempraktikkan ikatan buku sila dan bunga geti dengan betul serta mematuhi 5 perintah asas kawad kaki statik.',
    steps: [
      'Langkah 1: Pemeriksaan pakaian seragam lengkap dan disiplin barisan (15 minit).',
      'Langkah 2: Tunjuk cara ikatan buku sila dan bunga geti oleh guru penasihat (25 minit).',
      'Langkah 3: Latihan amali berpasangan dan pertandingan simpulan terpantas (30 minit).',
      'Langkah 4: Latihan kawad kaki statik dan nyanyian lagu rasmi unit beruniform (20 minit).'
    ],
    teachingAids: 'Tali rafia, Modul Pengakap / TKRS, Wisel, Bendera Pasukan',
    reflection: 'Semua unit beruniform menunjukkan semangat kerjasama dan disiplin yang amat membanggakan.',
    counselorName: 'Penolong Kanan Kokurikulum (PK Ko)',
    authorRole: 'pk_kokurikulum',
    status: 'menunggu',
    submittedAt: '2026-09-12T08:15:00.000Z'
  },
  {
    id: 'rph-ubk-minggu-25',
    week: 25,
    date: '2026-09-12',
    time: '09:00 PG - 10:00 PG',
    sessionType: 'Bimbingan Kelas Modular',
    focus: 'Psikososial & Kesejahteraan Mental Murid',
    title: 'Modul Minda Sihat: Pengurusan Tekanan Diri & Pengukuhan Emosi Positif',
    target: 'Tahun 6 Ibnu Sina (32 Murid)',
    venue: 'Bilik Bimbingan & Kaunseling',
    objective: 'Pada akhir sesi bimbingan, murid dapat mengenal pasti sekurang-kurangnya 2 punca tekanan menghadapi pentaksiran dan 3 teknik relaksasi pernafasan 4-7-8.',
    steps: [
      'Langkah 1: Set Induksi - Termometer Emosi untuk mengukur tahap perasaan murid hari ini.',
      'Langkah 2: Penerangan teknik relaksasi pernafasan dan senaman regangan santai minda.',
      'Langkah 3: Pengisian lembaran kerja \'Pokok Harapan dan Keyakinan Diri\'.',
      'Langkah 4: Rumusan ikrar motivasi diri bersama Guru Kaunselor.'
    ],
    teachingAids: 'Bahan Edaran Minda Sihat, Kad Emosi, Modul B&K, Audio Relaksasi',
    reflection: 'Murid menunjukkan respon yang amat positif dan lebih tenang selepas latihan relaksasi pernafasan.',
    counselorName: 'Guru Bimbingan & Kaunseling (UBK)',
    authorRole: 'kaunselor',
    status: 'menunggu',

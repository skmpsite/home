...
export const initialSchoolProfile: SchoolProfile = {
  ...
  songLyrics: [
    ...
    "Gagah melangkah menuju era baru,",
    "Menjulang kecemerlangan nusa dan bangsa.",
    "",
    "Berilmu, Beramal dan Berbakti,",
    "Pegang teguh pada ikrar janji,",
    "Guru berdedikasi mendidik seikhlas hati,",
    "Melahirkan insan berakhlak terpuji.",
    "",
    "Chorus:",
    "SKMP Maju! Cemerlang terbilang,",
    "Menjana modal insan gemilang,",
    "Nama harum dijulang sentiasa,",
    "Kebaikan ditebar serata dunia.",
    "",
    "Kitalah pewaris masa hadapan,",
    "Bertekad waja capai kejayaan,",
    "Maju bersama membina negara,",
    "SKMP Megah dan Berjaya!"
  ],
  songComposer: "Tn Hj Shukeri bin Hj Ibrahim",
  songLyricist: "Tn Hj Shukeri bin Hj Ibrahim",
  songArranger: "En Anuar bin Mohd Nor",
  songCreatedDate: "18 Mei 2024 (12.30 Malam)",
  songAudioUrl: "https://www.youtube.com/watch?v=dNCLSPCYAtc",
  locationCoords: {
    lat: 5.5682,
    lng: 100.6432,

...
export const initialSignageSlides: SignageSlide[] = [
  ...
  {
    id: "signage-slide-2",
    title: "Montaj Sambutan Bulan Kebangsaan & Hari Kemerdekaan",
    subtitle: "Saksikan klip video sambutan kibaran Jalur Gemilang dan persembahan koir patriotik murid SKMP",
    mediaType: "youtube",
    youtubeUrl: "https://www.youtube.com/watch?v=kXYiU_JCYtU",
    youtubeId: "kXYiU_JCYtU",
    imageUrl: "https://images.unsplash.com/photo-1532375810709-75b1da00537c?auto=format&fit=crop&q=80&w=1920",
    durationSeconds: 30,
